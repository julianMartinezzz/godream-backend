...
# Buscamos el pom.xml y compilamos donde sea que esté
RUN export PROJECT_DIR=$(find . -name "pom.xml" -exec dirname {} \;) && \
    cd $PROJECT_DIR && \
...
# Usamos find también para copiar los artefactos generados
